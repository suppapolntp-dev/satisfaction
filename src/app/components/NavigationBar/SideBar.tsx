...
// --- Component 1: Main Dashboard Sidebar ---
export function AdminSidebar() {
  const pathname = usePathname();

  const getNavLinkClass = (path: string) => {
    const baseClass = "d-flex align-items-center gap-3 px-4 py-3 rounded-4 text-decoration-none transition-all";
      ...
      <div className="p-4 d-flex flex-column gap-4">
        ...
        <div className="d-flex align-items-center gap-3 px-2">
          ...
          <div className="d-flex flex-column">
            <h1 className="mb-0 fw-bold text-dark" style={{ fontSize: "1.125rem", lineHeight: "1.2" }}>Brand</h1>
            <p className="mb-0 text-muted" style={{ fontSize: "0.75rem", fontWeight: 500 }}>Branch Name</p>
          </div>
        </div>
        ...
        <div className="bg-light p-3 rounded-4 border d-flex align-items-center gap-3">
          <div
            ...
            style={{
              ...
              backgroundImage: `url('https://ui-avatars.com/api/?name=Admin&background=random')`,
              backgroundSize: "cover",
            }}
          ></div>
          <div className="flex-grow-1 overflow-hidden">
            <p className="mb-0 fw-bold text-truncate text-dark small">Admin User</p>
            <p className="mb-0 text-muted text-truncate" style={{ fontSize: "0.75rem" }}>Super Group</p>
          </div>
        </div>
      </div>
    </aside>
    ...
    >
      <div className="p-3 border-bottom bg-white">
        <div className="form-check d-flex align-items-center gap-2">
          ...
          <label className="form-check-label small fw-bold text-uppercase text-muted pt-1 cursor-pointer" htmlFor="selectAll">
            Select All Brands
          </label>
        </div>
      </div>
